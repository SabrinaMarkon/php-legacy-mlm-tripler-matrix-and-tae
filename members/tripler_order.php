...
try {
	 ...
	 * Optional fields
	 */
	'fail_url'	=> $domain. '/members/tripler_order.php',
...
<input type="hidden" name="NOPAYMENT_URL" value="<?php echo $domain ?>/members/tripler_order.php">
...
<input type="hidden" name="ok_return_fail" value="<?php echo $domain ?>/members/tripler_order.php">
...
<input type="hidden" name="cancel_url"  value="<?php echo $domain ?>/members/tripler_order.php">
