...
if( session_is_registered("ulogin") ) {
    ...
    if ($done == "YES") {
        ...
        $query3 = "select * from buttons where added=1 and userid='".$_SESSION[uname]."'";
    	...
    	$query = "SELECT * FROM buttons where added=0 and userid='".$_SESSION[uname]."' limit 1";
		$result = mysql_query ($query)
			or die ("Query failed");
            ...
            $bannerurl = $line["bannerurl"];
        		...
        		if ($existing == 1) { ?><center>
	                <p><b>To add your credits to an existing campaign:</b></p>
	                   ...
	                   <select name="name">
	                <?
                        $query2 = "select * from buttons where added=1 and userid='".$_SESSION[uname]."'";
