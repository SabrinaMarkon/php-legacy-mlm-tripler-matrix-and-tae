...
include "../config.php";
$id = $_GET['id'];
$query = "select * from hheadlineads where id = '".$id."' LIMIT 1";
...
if ($numrows == 1) {
    ...
    $query1 = "select * from hheadlineadclicks where userid='".$userid."' and hheadlineadid=".$id;
...
echo "<font color=BLACK>You have earned <font color=RED><b>$earn</b></font> points</font>.&nbsp;&nbsp;";
		      ...
		      $query2 = "insert into hheadlineadclicks set userid='".$userid."', dateviewed=NOW(), hheadlineadid=".$id;
