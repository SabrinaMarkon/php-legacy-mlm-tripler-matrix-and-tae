...
$query = "select * from topnav where id = '".$id."' LIMIT 1";
...
if ($numrows == 1) {
    ...
    $query1 = "select * from topnavviews where userid='".$userid."' and blid=".$id;
...
echo "<font color=BLACK>You have earned <font color=RED><b>$earn</b></font> points.</font>&nbsp;&nbsp;";
		      ...
		      $query2 = "insert into topnavviews set userid='".$userid."', blid=".$id;
