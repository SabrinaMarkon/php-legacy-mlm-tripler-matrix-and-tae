...
$query = "select * from botnav where id = '".$id."' LIMIT 1";
...
if ($numrows == 1) {
    ...
    $query1 = "select * from botnavviews where userid='".$userid."' and blid=".$id;
...
echo "<font color=BLACK>You have earned <font color=RED><b>$earn</b></font> points.</font>&nbsp;&nbsp;";
		      ...
		      $query2 = "insert into botnavviews set userid='".$userid."', blid=".$id;
