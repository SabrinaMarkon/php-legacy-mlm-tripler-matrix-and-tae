...
if( session_is_registered("ulogin") )
 ...
 if ($memtype == "PRO" OR $memtype == "JV Member")  {

                echo "Only " . $toplevel . " Members Can Access This Page<br>Upgrade Your Account <a href=upgrade.php>Here</a>.<br><br>";

}  else{


        
		$query = "SELECT * FROM pages where name='SUPER JV Bonuses'";
